        ...
        <div className="about">
            <div className="container about-container">
                ...
                <article className="about-text">
                    <p>This is a mock blog website that's part my React Showcase projects, and part of my <a href="https://lincoldarhen.com">lincoldarhen.com</a>. This is solely made to show my React.js skills.</p>
                </article>
                <form action="#">
